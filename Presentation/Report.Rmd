...
We initially felt that this would be a problem. However, even if the data wasn’t normally distributed, since we have around 10,000 rows, it is believed that the sample size is sufficiently large. Lastly, as previously stated, we make the equal-variance assumption.
