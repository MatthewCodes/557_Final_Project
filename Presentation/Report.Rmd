...
For each of these questions, we aimed to test for both the presence of differences between groups, and for certain relationships by using regression.
