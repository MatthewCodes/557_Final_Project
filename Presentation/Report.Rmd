...
## Discussion
We first address our original assumptions about Question #1: we did not ultimately receive more data from the high density areas. In fact, we actually received more data from the low density areas.
