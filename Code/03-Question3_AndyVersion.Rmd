...
power=NULL,sig.level=0.05,n=c(700, 1500, 800, 94))

anovaP
```

Like the multiple t - test, ANOVA would have a power of 1 given our sample size and the variances present in the data.
...
```{r}
summary(lm(d$d0.CompensationYearUSD ~ d$d0.FormalEducation, data=d))
```
