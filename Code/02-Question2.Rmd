...
```{r, Q2_histograms, echo= FALSE, message=FALSE}
...
```{r, glm-assumptions, echo=FALSE, warning=FALSE}
...
scatter.smooth(fitjob$linear.predictors,r.jobs,cex=0.8,col="gray")
scatter.smooth(fitjob$linear.predictors,abs(r.jobs),cex=0.8,col="gray")

qqnorm(fitjob$residuals,main = "Normal Q-Q Plot for Job Title GLM")
