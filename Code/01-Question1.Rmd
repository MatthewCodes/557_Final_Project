...
```{r, pre_plots, eval=TRUE,message=FALSE, warning=FALSE}
...
```{r, Question_1_plot_salary, dependson= "testing", eval=TRUE}
...
```{r, Question_1_plot_commission, dependson= "testing", eval=TRUE}
