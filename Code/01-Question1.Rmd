...
ggplot(aes(x=CompensationYearUSD), data= commision)+ geom_histogram() + labs(title="Histogram of High Density Commission",
        x ="Compensation", y = "Count") +stat_bin(bins = 25) + scale_x_continuous(labels = dollar) + annotate("text", label = "Mu: $11,187",x = 10000, y=15, color= "white")
dev.off()
...
ggplot(aes(x=CompensationYearUSD), data= commision2)+ geom_histogram()+ labs(title="Histogram of Low Density Commission",
        x ="Compensation", y = "Count") + stat_bin(bins = 25) + scale_x_continuous(labels = dollar) + annotate("text", label = "Mu: $13,171",x = 10000, y=15, color= "white")
dev.off()
